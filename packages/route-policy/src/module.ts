...
export class RoutePolicyModule implements RouteModule {
  ...
  readonly availability = {
    available: true,
    platforms: ['node', 'electron', 'ios', 'android', 'web'] as const,
  };
  private lifecycle: LifecycleState = 'idle';
  private readonly instance: LocalFirstRoutePolicy;
  constructor(
    dependencies: RoutePolicyDependencies = {},
    readonly defaults: RoutePolicyOptions = {},
  ) {
    this.instance = new LocalFirstRoutePolicy(dependencies);
  }
  get state() {
    return this.lifecycle;
  }
  get policy(): RoutePolicyLike {
    return this.instance;
  }
  async start(_context: ModuleContext) {
